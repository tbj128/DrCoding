...
args = {
    ...
    "full_data_dir": "/Users/boyanjin/Documents/Stanford/CS224N/Project/DrCoding/data_v2",
    "task_name": "toxic_multilabel",
    "no_cuda": True,
    # "bert_model": 'bert-base-uncased',
    "bert_model": '/Users/boyanjin/Documents/Stanford/CS224N/Project/biobert',
    "output_dir": 'output',
    "max_seq_length": 512,
    "do_train": True,
    "do_eval": True,
...
class BertForMultiLabelSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config, num_labels=50):
...
class MultiLabelTextProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        if self.labels == None:
            self.labels = list(pd.read_csv(os.path.join(self.data_dir, "icd.txt"), header=None)[0].values)
        return self.labels
